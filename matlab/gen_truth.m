...
xstart(:,1)  = [model.BM(1,5:7)'; model.BM(1,2:4)'; model.E2B'*model.BM(1,69:71)'];      tbirth(1)  = 1;     tdeath(1)  = truth.K+1;
xstart(:,2)  = [model.BM2(1,5:7)'; model.BM2(1,2:4)'; model.E2B'*model.BM2(1,69:71)'];         tbirth(2)  = 1;    tdeath(2)  = truth.K+1;
...
elseif targetnum==2
    targetstate = [model.BM2(k,5:7)'; model.BM2(k,2:4)'; model.E2B'*model.BM2(k,69:71)'];
end
