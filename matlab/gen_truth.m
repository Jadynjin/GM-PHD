...
xstart(:,1)  = [model.BM(1,5:6)'; model.BM(1,2:3)'];      tbirth(1)  = 1;     tdeath(1)  = truth.K+1;
xstart(:,2)  = [model.BM2(1,5:6)'; model.BM2(1,2:3)'];         tbirth(2)  = 1;    tdeath(2)  = truth.K+1;
...
if targetnum==1
        ...
        targetstate = [model.BM(k,5:6)'; model.BM(k,2:3)'];
elseif targetnum==2
    targetstate = [model.BM2(k,5:6)'; model.BM2(k,2:3)'];
end
